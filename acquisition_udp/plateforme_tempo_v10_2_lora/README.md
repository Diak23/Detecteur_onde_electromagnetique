# Plateforme TEMPO V10.2 — instrument multimode

La V10.2 sépare clairement les données simulées des mesures physiques et
améliore l'affichage multi-sources avec des sous-graphes indépendants.
...
```bash
cd ~/acquisition_udp
unzip plateforme_tempo_v10_2_lora.zip
cd plateforme_tempo_v10_2_lora
