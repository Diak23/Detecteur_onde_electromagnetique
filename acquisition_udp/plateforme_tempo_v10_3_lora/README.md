# Plateforme TEMPO V10.3 — instrument multimode

La V10.3 sépare clairement les données simulées des mesures physiques et
améliore l'affichage multi-sources avec des sous-graphes indépendants. Les
simulations RF à 868 MHz et 2,45 GHz sont superposées dans un même panneau
afin de faciliter leur comparaison temporelle.
...
```bash
cd ~/acquisition_udp
unzip plateforme_tempo_v10_3_lora.zip
cd plateforme_tempo_v10_3_lora
